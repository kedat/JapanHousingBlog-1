...
const allTranslations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'footer.description': 'Exploring Japanese architecture, real estate, and design through insightful articles and analysis.',
    // Auth Page
    'auth.login': 'Login',
  ...
  ja: {
    ...
    'footer.description': '日本の建築、不動産、デザインについて洞察に満ちた記事と分析を通じて探ります。',
    // Auth Page
    'auth.login': 'ログイン',
    'auth.register': '登録',
    'auth.username': 'ユーザー名',
  ...
  vi: {
    ...
    'footer.description': 'Khám phá kiến trúc, bất động sản và thiết kế Nhật Bản thông qua các bài viết phân tích chuyên sâu.',
    // Auth Page
